...
# left and right of it, and ectrera. On and on, exponential growth. They are allowed to make
#path end early to reduce work - path can lead to deaths or wins or boring things earlier than
#the rest of the tree.
#The easiest way to make this work i imagine is to have them send you their node trees
